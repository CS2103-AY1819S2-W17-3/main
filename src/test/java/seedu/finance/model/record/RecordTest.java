...
public class RecordTest {
    ...
    public void isSameRecord() {
        ...
        editedAlice = new RecordBuilder(ALICE).withDate(VALID_DATE_BOB).withCategories(VALID_CATEGORY_FRIEND).build();
        assertTrue(ALICE.isSameRecord(editedAlice));

        // same name, same date, different attributes -> returns true
        editedAlice = new RecordBuilder(ALICE).withAmount(VALID_AMOUNT_BOB).withCategories(VALID_CATEGORY_FRIEND)
                .build();
        assertTrue(ALICE.isSameRecord(editedAlice));
    }
    ...
    public void equals() {
        ...
        editedAlice = new RecordBuilder(ALICE).withCategories(VALID_CATEGORY_FRIEND).build();
        assertFalse(ALICE.equals(editedAlice));
    }
}
