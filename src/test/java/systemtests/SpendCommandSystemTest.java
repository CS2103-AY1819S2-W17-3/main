...
public class SpendCommandSystemTest extends FinanceTrackerSystemTest {
    ...
    public void spend() {
        ...
        String command = "   " + SpendCommand.COMMAND_WORD + "  " + NAME_DESC_AMY + "   " + AMOUNT_DESC_AMY + "   "
                + DATE_DESC_AMY + "   " + CATEGORY_DESC_DINING + " ";
        ...
        command = SpendCommand.COMMAND_WORD + NAME_DESC_BOB + AMOUNT_DESC_AMY + DATE_DESC_AMY + CATEGORY_DESC_DINING;
        assertCommandSuccess(command, toSpend);
        ...
        toSpend = BOB;
        command = SpendCommand.COMMAND_WORD + CATEGORY_DESC_DINING + NAME_DESC_BOB + CATEGORY_DESC_SHOPPING
