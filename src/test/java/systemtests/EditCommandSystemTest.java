...
public class EditCommandSystemTest extends FinanceTrackerSystemTest {
    ...
    public void edit() {
        ...
        Record editedRecord = new RecordBuilder(BOB).withCategories(VALID_CATEGORY_DINING).build();
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + AMOUNT_DESC_BOB
                + DATE_DESC_BOB + CATEGORY_DESC_SHOPPING + CATEGORY_DESC_DINING;
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_AMY
                + AMOUNT_DESC_BOB + DATE_DESC_BOB + CATEGORY_DESC_SHOPPING + CATEGORY_DESC_DINING;
        ...
        selectRecord(index);
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_AMY
                + AMOUNT_DESC_AMY + DATE_DESC_AMY + CATEGORY_DESC_SHOPPING;
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB
                + AMOUNT_DESC_AMY + DATE_DESC_BOB + CATEGORY_DESC_SHOPPING + CATEGORY_DESC_DINING;
        assertCommandFailure(command, EditCommand.MESSAGE_DUPLICATE_RECORD);

        /* Case: edit a record with new values same as another record's values but with different date -> rejected */
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB
                + AMOUNT_DESC_BOB + DATE_DESC_AMY + CATEGORY_DESC_SHOPPING + CATEGORY_DESC_DINING;
        assertCommandFailure(command, EditCommand.MESSAGE_DUPLICATE_RECORD);
    }
